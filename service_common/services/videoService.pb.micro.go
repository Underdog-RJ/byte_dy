...
type VideoService interface {
	...
	FeedVideo(ctx context.Context, in *DouyinFeedRequest, opts ...client.CallOption) (*DouyinFeedResponse, error)
}
...
func (c *videoService) FeedVideo(ctx context.Context, in *DouyinFeedRequest, opts ...client.CallOption) (*DouyinFeedResponse, error) {
	req := c.c.NewRequest(c.name, "VideoService.FeedVideo", in)
...
type VideoServiceHandler interface {
	...
	FeedVideo(context.Context, *DouyinFeedRequest, *DouyinFeedResponse) error
}
...
func RegisterVideoServiceHandler(s server.Server, hdlr VideoServiceHandler, opts ...server.HandlerOption) error {
	type videoService interface {
		...
		FeedVideo(ctx context.Context, in *DouyinFeedRequest, out *DouyinFeedResponse) error
	}
	type VideoService struct {
		videoService
	}
...
func (h *videoServiceHandler) FeedVideo(ctx context.Context, in *DouyinFeedRequest, out *DouyinFeedResponse) error {
	return h.VideoServiceHandler.FeedVideo(ctx, in, out)
}
