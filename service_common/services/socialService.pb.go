...
var file_socialService_proto_rawDesc = []byte{
	...
	0x75, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69,
	...
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x97, 0x01, 0x0a, 0x26, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x93, 0x01, 0x0a, 0x24, 0x64, 0x6f,
	...
	0x6c, 0x6f, 0x77, 0x22, 0x56, 0x0a, 0x25, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x72, 0x65,
	...
	0x67, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
...
var file_socialService_proto_goTypes = []interface{}{
	...
	(*DouyinRelationFollowerListRequest)(nil),  // 6: services.douyin_relation_follower_list_request
	...
	(*DouyinMessageChatRequest)(nil),           // 10: services.douyin_message_chat_request
	(*DouyinMessageChatResponse)(nil),          // 11: services.douyin_message_chat_response
	(*Message)(nil),                            // 12: services.Message
	(*DouyinRelationFollowerListResponse)(nil), // 13: services.douyin_relation_follower_list_response
}
var file_socialService_proto_depIdxs = []int32{
	5,  // 0: services.douyin_relation_follow_list_response.user_list:type_name -> services.User
	9,  // 1: services.douyin_relation_friend_list_response.user_list:type_name -> services.FriendUser
	12, // 2: services.douyin_message_chat_response.message_list:type_name -> services.Message
	5,  // 3: services.douyin_relation_follower_list_response.user_list:type_name -> services.User
	...
	6,  // 6: services.SocialService.RelationFollowerList:input_type -> services.douyin_relation_follower_list_request
	7,  // 7: services.SocialService.RelationFriendList:input_type -> services.douyin_relation_friend_list_request
	1,  // 8: services.SocialService.MessageAction:input_type -> services.douyin_relation_action_request_content
	10, // 9: services.SocialService.MessageChat:input_type -> services.douyin_message_chat_request
	...
	13, // 12: services.SocialService.RelationFollowerList:output_type -> services.douyin_relation_follower_list_response
	8,  // 13: services.SocialService.RelationFriendList:output_type -> services.douyin_relation_friend_list_response
	2,  // 14: services.SocialService.MessageAction:output_type -> services.douyin_relation_action_response
	11, // 15: services.SocialService.MessageChat:output_type -> services.douyin_message_chat_response
