...
type UserInfo struct {
	...
	IsFollow      uint32 `protobuf:"varint,5,opt,name=IsFollow,proto3" json:"IsFollow,omitempty"`
}
...
func (x *UserInfo) GetIsFollow() uint32 {
	if x != nil {
		return x.IsFollow
	}
	return 0
...
var file_userInfo_proto_rawDesc = []byte{
	...
	0x08, 0x49, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52,
