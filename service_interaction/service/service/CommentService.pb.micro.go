...
type CommentService interface {
	CommentAction(ctx context.Context, in *CommentRequest, opts ...client.CallOption) (*CommentResponse, error)
}
...
func (c *commentService) CommentAction(ctx context.Context, in *CommentRequest, opts ...client.CallOption) (*CommentResponse, error) {
...
func RegisterCommentServiceHandler(s server.Server, hdlr CommentServiceHandler, opts ...server.HandlerOption) error {
	type commentService interface {
		CommentAction(ctx context.Context, in *CommentRequest, out *CommentResponse) error
	}
	type CommentService struct {
		commentService
	}
...
func (h *commentServiceHandler) CommentAction(ctx context.Context, in *CommentRequest, out *CommentResponse) error {
